...
'			Me.schedulerStorage1.ResourcesDeleted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnResourcesChanged);
'			Me.schedulerStorage1.AppointmentsChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnAppointmentsChanged);
'			Me.schedulerStorage1.ResourcesChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnResourcesChanged);
'			Me.schedulerStorage1.ResourcesInserted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnResourcesChanged);
'			Me.schedulerStorage1.AppointmentsInserted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnAppointmentsChanged);
'			Me.schedulerStorage1.AppointmentsDeleted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnAppointmentsChanged);
			' 
			' dateNavigator1
			' 
